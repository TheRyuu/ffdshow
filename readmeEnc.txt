...
using libavcodec library from FFmpeg project for compression. Few other compression
libraries are supported too.
...
2. Features:
   ...
   - minimum and maximum quantizer selection, quantizer type and trellis quantization
     selection for libavcodec
   - adaptive quantization (aka. masking) for libavcodec and Xvid, single coefficient
     elimination
