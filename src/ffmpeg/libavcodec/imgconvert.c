...
convert_table[PIX_FMT_RGBA32][PIX_FMT_BGR24].convert = rgba32_to_bgr24;
...
convert_table[PIX_FMT_BGR24][PIX_FMT_RGBA32].convert = bgr24_to_rgba32;
...
convert_table[PIX_FMT_RGB565][PIX_FMT_RGBA32].convert = rgb565_to_rgba32;
