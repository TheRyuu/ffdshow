...
void TcodecsPageVideo::fillCodecs(void)
{
    if ((filterMode&IDFF_FILTERMODE_VIDEORAW)==0) {
        ...
        formats.push_back(Tformat(_l("H.264/AVC")     ,IDFF_h264,IDFF_MOVIE_LAVC,_l("H264, AVC1, X264, VSSH (incomplete), DAVC, PAVC. ffmpeg-mt is multithreaded."),options_h264));
        ...
        formats.push_back(Tformat(_l("Real Video 3")  ,IDFF_rv30,IDFF_MOVIE_LAVC,_l("Real Video (RV30)"),NULL,LAVC_UNSTABLE));
...
void TcodecsPageAudio::fillCodecs(void)
{
    if ((filterMode&IDFF_FILTERMODE_AUDIORAW)==0) {
        static const int movie_mp23[]= {IDFF_MOVIE_LIBMAD,IDFF_MOVIE_LAVC,0};
        ...
        formats.push_back(Tformat(_l("TrueHD")      ,IDFF_truehd     ,IDFF_MOVIE_LAVC,_l("Dolby TrueHD decoder. Works only if AC3 decoding is enabled!")));
        ...
        formats.push_back(Tformat(_l("Vorbis")      ,IDFF_vorbis     ,IDFF_MOVIE_LAVC,_l("Vorbis audio decoder")));
        ...
        formats.push_back(Tformat(_l("MS IMA ADPCM"),IDFF_iadpcm     ,IDFF_MOVIE_LAVC,_l("MS IMA Adaptive DPCM")));
