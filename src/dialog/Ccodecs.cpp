 ...
 if ((filterMode&IDFF_FILTERMODE_VIDEORAW)==0)
  {
   ...
   formats.push_back(Tformat(_l("SVQ1")       ,IDFF_svq1,IDFF_MOVIE_LAVC,_l("Sorenson (SVQ1) Video")));
   formats.push_back(Tformat(_l("SVQ3")       ,IDFF_svq3,IDFF_MOVIE_LAVC,_l("Sorenson (SVQ3) Video")));
   formats.push_back(Tformat(_l("QTRLE")      ,IDFF_qtrle,IDFF_MOVIE_LAVC,_l("Quicktime Animation (RLE) Video")));
   formats.push_back(Tformat(_l("RPZA")       ,IDFF_qtrpza,IDFF_MOVIE_LAVC,_l("Quicktime Video (RPZA) Video")));
   formats.push_back(Tformat(_l("FFV1")       ,IDFF_ffv1,IDFF_MOVIE_LAVC,_l("FFV1 codec for libavcodec")));
   ...
   formats.push_back(Tformat(_l("MSRLE")      ,IDFF_rle ,IDFF_MOVIE_LAVC,_l("MS RLE Video")));
   formats.push_back(Tformat(_l("MSZH")       ,IDFF_mszh,IDFF_MOVIE_LAVC,_l("MSZH (LossLess Codec Library)")));
   ...
   formats.push_back(Tformat(_l("ZLIB")       ,IDFF_zlib,IDFF_MOVIE_LAVC,_l("ZLIB (LossLess Codec Library)")));   
   formats.push_back(Tformat(_l("DV")         ,IDFF_dvsd,IDFF_MOVIE_LAVC,_l("dvsd, DVSD, DV25, DV50")));
   formats.push_back(Tformat(_l("CYUV")       ,IDFF_cyuv,IDFF_MOVIE_LAVC,_l("Creative YUV (CYUV) Video")));
   formats.push_back(Tformat(_l("ASV1/2")     ,IDFF_asv1,IDFF_MOVIE_LAVC,_l("ASUS V1/V2")));
   ...
   formats.push_back(Tformat(_l("8BPS")       ,IDFF_8bps,IDFF_MOVIE_LAVC,_l("Quicktime Planar RGB (8BPS) Video")));
   formats.push_back(Tformat(_l("CorePNG,MPNG"),IDFF_png1,IDFF_MOVIE_LAVC,_l("CorePNG (PNG1, MPNG)")));
   ...
   formats.push_back(Tformat(_l("QPEG")       ,IDFF_qpeg,IDFF_MOVIE_LAVC,_l("QPEG, Q1.0, Q1.1")));
   ...
   formats.push_back(Tformat(_l("AASC")       ,IDFF_aasc,IDFF_MOVIE_LAVC,_l("Autodesc RLE (AASC)")));
   formats.push_back(Tformat(_l("RV10,RV20")  ,IDFF_rv10,IDFF_MOVIE_LAVC,_l("RV10, RV20 (incomplete)")));
   formats.push_back(Tformat(_l("FPS1")       ,IDFF_fps1,IDFF_MOVIE_LAVC,_l("Fraps FPS1, (v0, v1, v2 & v4)")));
   formats.push_back(Tformat(_l("Chinese AVS") ,IDFF_cavs,IDFF_MOVIE_LAVC,_l("Chinese AVS video (AVS1-P2, JiZhun profile) decoder;May not work without a special mpeg splitter.")));
 ...
 if ((filterMode&IDFF_FILTERMODE_AUDIORAW)==0)
  {
   ...
   static const Tformat::Toption options_ac3[]={{IDFF_MOVIE_LIBA52,_l("Dynamic range compression"),IDFF_ac3drc,1},{0,NULL,0}};
   formats.push_back(Tformat(_l("AC3")         ,IDFF_ac3   ,movie_ac3,_l("ATSC A-52 stream decoder"),options_ac3));
   static const int movie_dts[]={IDFF_MOVIE_LIBDTS,IDFF_MOVIE_SPDIF,0};
   static const Tformat::Toption options_dts[]={{IDFF_MOVIE_LIBDTS,_l("Dynamic range compression"),IDFF_dtsdrc,1},{0,_l("Check for DTS in WAV"),IDFF_dtsinwav,1},{NULL,0}};
