        ...
        case WM_COMMAND:
            switch (LOWORD(wParam)) {
                ...
                case IDC_CHB_X264_ME_INTRA_BSUB16x16: {
                    int intra=0;
                    if (getCheck(IDC_CHB_X264_ME_INTRA_I4x4     )) {
                        intra|=X264_ANALYSE_I4x4;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTRA_I8x8     )) {
                        intra|=X264_ANALYSE_I8x8;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTRA_PSUB16x16)) {
                        intra|=X264_ANALYSE_PSUB16x16;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTRA_PSUB8x8  )) {
                        intra|=X264_ANALYSE_PSUB8x8;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTRA_BSUB16x16)) {
                        intra|=X264_ANALYSE_BSUB16x16;
                    }
                ...
                case IDC_CHB_X264_ME_INTER_BSUB16x16: {
                    int inter=0;
                    if (getCheck(IDC_CHB_X264_ME_INTER_I4x4     )) {
                        inter|=X264_ANALYSE_I4x4;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTER_I8x8     )) {
                        inter|=X264_ANALYSE_I8x8;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTER_PSUB16x16)) {
                        inter|=X264_ANALYSE_PSUB16x16;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTER_PSUB8x8  )) {
                        inter|=X264_ANALYSE_PSUB8x8;
                    }
                    if (getCheck(IDC_CHB_X264_ME_INTER_BSUB16x16)) {
