...
{
    cbxSetCurSel(IDC_CBX_ME_CMP,cfgGet(IDFF_enc_me_cmp));
    setCheck(IDC_CHB_ME_CMP_CHROMA,cfgGet(IDFF_enc_me_cmp_chroma));
    cbxSetCurSel(IDC_CBX_ME_SUBCMP,cfgGet(IDFF_enc_me_subcmp));
    setCheck(IDC_CHB_ME_SUBCMP_CHROMA,cfgGet(IDFF_enc_me_subcmp_chroma));
    cbxSetCurSel(IDC_CBX_MB_CMP,cfgGet(IDFF_enc_mb_cmp));
    ...
    setCheck(IDC_CHB_MV0,cfgGet(IDFF_enc_me_mv0));
    enable(sup_me_mv0(codecId) && cfgGet(IDFF_enc_me_hq)>0,IDC_CHB_MV0);
    setCheck(IDC_CHB_CBP_RD,cfgGet(IDFF_enc_me_cbp_rd));
    enable(sup_trellisQuant(codecId) && cfgGet(IDFF_enc_trellisquant),IDC_CHB_CBP_RD);
...
void TmePage::translate(void)
{
    ...
    cbxClear(IDC_CBX_DIA_SIZE);
    cbxClear(IDC_CBX_DIA_SIZE_PRE);
    ...
    cbxSetCurSel(IDC_CBX_DIA_SIZE,sel1);
    cbxSetCurSel(IDC_CBX_DIA_SIZE_PRE,sel2);
}
