...
void TmeXvidPage::cfg2dlg(void)
{
    ...
    setCheck(IDC_CHB_XVID_CHROMA_ME,cfgGet(IDFF_enc_me_cmp_chroma));
    enable(!cfgGet(IDFF_enc_gray),IDC_CHB_XVID_CHROMA_ME);
        ...
        case WM_COMMAND:
            switch (LOWORD(wParam)) {
                ...
                case IDC_CHB_XVIDME_USESQUARES8      : {
                    int me=0;
                    if (getCheck(IDC_CHB_XVIDME_ADVANCEDDIAMOND16)) {
                        me|=XVID_ME::ADVANCEDDIAMOND16;
                    }
                    if (getCheck(IDC_CHB_XVIDME_HALFPELREFINE16  )) {
                        me|=XVID_ME::HALFPELREFINE16  ;
                    }
                    if (getCheck(IDC_CHB_XVIDME_EXTSEARCH16      )) {
                        me|=XVID_ME::EXTSEARCH16      ;
                    }
                    if (getCheck(IDC_CHB_XVIDME_USESQUARES16     )) {
                        me|=XVID_ME::USESQUARES16     ;
                    }

                    if (getCheck(IDC_CHB_XVIDME_ADVANCEDDIAMOND8 )) {
                        me|=XVID_ME::ADVANCEDDIAMOND8 ;
                    }
                    if (getCheck(IDC_CHB_XVIDME_HALFPELREFINE8   )) {
                        me|=XVID_ME::HALFPELREFINE8   ;
                    }
                    if (getCheck(IDC_CHB_XVIDME_EXTSEARCH8       )) {
                        me|=XVID_ME::EXTSEARCH8       ;
                    }
                    if (getCheck(IDC_CHB_XVIDME_USESQUARES8      )) {
                        me|=(int)XVID_ME::USESQUARES8 ;
                    }
                ...
                case IDC_CHB_XVIDVHQ_QUARTERPELREFINE8_BITS: {
                    int vhq=0;
                    if (getCheck(IDC_CHB_XVIDVHQ_EXTSEARCH_BITS         )) {
                        vhq|=XVID_ME_RD::EXTSEARCH         ;
                    }
                    if (getCheck(IDC_CHB_XVIDVHQ_CHECKPREDICTION_BITS   )) {
                        vhq|=XVID_ME_RD::CHECKPREDICTION   ;
                    }
                    if (getCheck(IDC_CHB_XVIDVHQ_HALFPELREFINE16_BITS   )) {
                        vhq|=XVID_ME_RD::HALFPELREFINE16   ;
                    }
                    if (getCheck(IDC_CHB_XVIDVHQ_HALFPELREFINE8_BITS    )) {
                        vhq|=XVID_ME_RD::HALFPELREFINE8    ;
                    }
                    if (getCheck(IDC_CHB_XVIDVHQ_QUARTERPELREFINE16_BITS)) {
                        vhq|=XVID_ME_RD::QUARTERPELREFINE16;
                    }
                    if (getCheck(IDC_CHB_XVIDVHQ_QUARTERPELREFINE8_BITS )) {
                        vhq|=XVID_ME_RD::QUARTERPELREFINE8 ;
                    }
