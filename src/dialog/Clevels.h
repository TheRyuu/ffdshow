...
private:
    ...
    public:
        TwidgetLevels(HWND h, TlevelsPage *Iself, int IidffMin, int IidffMax): levelsPage(Iself), TwindowWidget(h, Iself), dragIdff(0), idffMin(IidffMin), idffMax(IidffMax), dx(0) {
            allowOwnProc();
        }
