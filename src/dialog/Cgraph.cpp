...
void TgraphPage::init(void)
{
    ...
    graphBmp.bmiColors[1].rgbRed = 155;
    graphBmp.bmiColors[1].rgbGreen = 110;
    graphBmp.bmiColors[1].rgbBlue =  0; //1 - grid
    graphBmp.bmiColors[2].rgbRed = 255;
    graphBmp.bmiColors[2].rgbGreen = 255;
    graphBmp.bmiColors[2].rgbBlue = 255; //2 - quant
    graphBmp.bmiColors[3].rgbRed =  0;
    graphBmp.bmiColors[3].rgbGreen =  0;
    graphBmp.bmiColors[3].rgbBlue = 255; //3 - p-frames
    graphBmp.bmiColors[4].rgbRed = 255;
    graphBmp.bmiColors[4].rgbGreen =  0;
    graphBmp.bmiColors[4].rgbBlue =  0; //4 - i-frames
    graphBmp.bmiColors[5].rgbRed = 128;
    graphBmp.bmiColors[5].rgbGreen = 128;
    graphBmp.bmiColors[5].rgbBlue = 128; //5 - b-frames
    graphBmp.bmiColors[6].rgbRed = 255;
    graphBmp.bmiColors[6].rgbGreen = 255;
    graphBmp.bmiColors[6].rgbBlue = 255; //6 - text
