...
void TnoisePage::noise2dlg(void)
{
    ...
    enable(method != 0, IDC_CHB_NOISE_PATTERN);
    setCheck(IDC_CHB_NOISE_PATTERN, cfgGet(IDFF_noisePattern));
    enable(method == 2, IDC_CHB_NOISE_AVG);
    setCheck(IDC_CHB_NOISE_AVG    , cfgGet(IDFF_noiseAveraged));
...
void TnoisePage::flicker2dlg(void)
{
    ...
    tbrSet(IDC_TBR_FLICKER_A, a);
    tbrSet(IDC_TBR_FLICKER_F, f);
...
void TnoisePage::shake2dlg(void)
{
    ...
    tbrSet(IDC_TBR_SHAKE_A, a);
    tbrSet(IDC_TBR_SHAKE_F, f);
...
void TnoisePage::lines2dlg(void)
{
    ...
    tbrSet(IDC_TBR_LINES_A, a);
    tbrSet(IDC_TBR_LINES_F, f);
    tbrSet(IDC_TBR_LINES_TRANSPARENCY, t);
    tbrSet(IDC_TBR_LINES_C, c);
...
void TnoisePage::scratches2dlg(void)
{
    ...
    tbrSet(IDC_TBR_SCRATCHES_A, a);
    tbrSet(IDC_TBR_SCRATCHES_F, f);
    tbrSet(IDC_TBR_SCRATCHES_TRANSPARENCY, t);
    tbrSet(IDC_TBR_SCRATCHES_C, c);
