...
void TcurveAltPage::cfg2dlg(void)
{
    ...
    setCheck(IDC_RBT_CURVEALT_USEAUTO,cfgGet(IDFF_enc_alt_curve_use_auto));
    enable(is,IDC_RBT_CURVEALT_USEAUTO);
    ...
    setCheck(IDC_RBT_CURVEALT_USEMANUAL,!cfgGet(IDFF_enc_alt_curve_use_auto));
    enable(is,IDC_RBT_CURVEALT_USEMANUAL);
    ...
    setCheck(IDC_CHB_CURVEALT_BONUSBIASMANUAL,!cfgGet(IDFF_enc_alt_curve_use_auto_bonus_bias));
    enable(is,IDC_CHB_CURVEALT_BONUSBIASMANUAL);
