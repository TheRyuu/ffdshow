    ...
    STDMETHODIMP getRange(int cap, int *min, int *max) {
        ...
        switch (cap) {
            case HWOC_BRIGHTNESS:
                *min = HWOC_BRIGHTNESS_MIN;
                *max = HWOC_BRIGHTNESS_MAX;
                return S_OK;
            case HWOC_CONTRAST  :
                *min = HWOC_CONTRAST_MIN  ;
                *max = HWOC_CONTRAST_MAX  ;
                return S_OK;
            case HWOC_HUE       :
                *min = HWOC_HUE_MIN       ;
                *max = HWOC_HUE_MAX       ;
            ...
            case HWOC_SATURATION:
                *min = HWOC_SATURATION_MIN;
                *max = HWOC_SATURATION_MAX;
                return S_OK;
            case HWOC_SHARPNESS :
                *min = HWOC_SHARPNESS_MIN ;
                *max = HWOC_SHARPNESS_MAX ;
                return S_OK;
            case HWOC_GAMMA     :
                *min = HWOC_GAMMA_MIN     ;
                *max = HWOC_GAMMA_MAX     ;
