...
template<class _mm> TimgFilterBitmap::Tblendplane TimgFilterBitmap::getBlend(int mode)
{
    switch (mode) {
        ...
        default:
            return blend<_mm>;
        case TbitmapSettings::MODE_DARKEN:
            return darken<_mm>;
        case TbitmapSettings::MODE_LIGHTEN:
            return lighten<_mm>;
        case TbitmapSettings::MODE_ADD:
            return add<_mm>;
        case TbitmapSettings::MODE_SOFTLIGHT:
            return softlight<_mm>;
        case TbitmapSettings::MODE_EXCLUSION:
            return exclusion<_mm>;
    }
}
