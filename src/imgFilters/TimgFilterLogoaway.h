...
private:
int oldLumaOnly, oldBlur, oldMode;
char_t oldparambitmap[MAX_PATH];
TffPict logotemp;
Tbuffer logotempbuf;
TffPict *parambitmap;
Tbuffer parambitmapbuf;
...
public:
    ...
    int shiftX, shiftY;
    int w, h;
    unsigned char *logotempdata;
    stride_t logotempstride;
    int solidcolor;
    static const int SHAPEMAP_NOCHANGE = 16;
    static const int SHAPEMAP_CONTOUR = 236;
    const unsigned char *parambitmapdata;
    stride_t parambitmapstride;
