...
private:
 ...
 class TrenderedSubtitleLineBitmap :public TrenderedSubtitleWordBase
  ...
  public:
   ...
   Tblendplane blend;
   virtual void print(int startx, int starty /* not used */,unsigned int dx[3],int dy1[3],unsigned char *dstLn[3],const stride_t stride[3],const unsigned char *bmp[3],const unsigned char *msk[3]) const;
  } w;
