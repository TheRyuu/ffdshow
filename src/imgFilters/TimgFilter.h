...
private:
    ...
    bool getCur(uint64_t csp, TffPict &pict, int full, const unsigned char **src[4]);
    bool getNext(uint64_t csp, TffPict &pict, int full, unsigned char **dst[4], const Trect *rect2 = NULL);
    bool getNext(uint64_t csp, TffPict &pict, const Trect &clipRect, unsigned char **dst[4], const Trect *rect2 = NULL);
    bool getCurNext(uint64_t csp, TffPict &pict, int full, int copy, unsigned char **dst[4], Tbuffer &buf);
...
protected:
    ...
    virtual uint64_t getSupportedInputColorspaces(const TfilterSettingsVideo *cfg) const = 0;
    ...
    bool getCur(uint64_t csp, TffPict &pict, int full, const unsigned char **src0, const unsigned char **src1, const unsigned char **src2, const unsigned char **src3) {
    ...
    bool getNext(uint64_t csp, TffPict &pict, int full, unsigned char **dst0, unsigned char **dst1, unsigned char **dst2, unsigned char **dst3, const Trect *rect2 = NULL) {
    ...
    bool getNext(uint64_t csp, TffPict &pict, const Trect &clipRect, unsigned char **dst0, unsigned char **dst1, unsigned char **dst2, unsigned char **dst3, const Trect *rect2 = NULL) {
        unsigned char **dst[4] = {dst0, dst1, dst2, dst3};
    ...
    bool getCurNext(uint64_t csp, TffPict &pict, int full, int copy, unsigned char **dst0, unsigned char **dst1, unsigned char **dst2, unsigned char **dst3) {
        unsigned char **dst[4] = {dst0, dst1, dst2, dst3};
        return getCurNext(csp, pict, full, copy, dst, own2);
    }
    bool getCurNext(uint64_t csp, TffPict &pict, int full, int copy, unsigned char *dst[4]) {
        unsigned char **dstP[4] = {&dst[0], &dst[1], &dst[2], &dst[3]};
        return getCurNext(csp, pict, full, copy, dstP, own2);
    }
    bool getCurNext3(uint64_t csp, TffPict &pict, int full, int copy, unsigned char *dst[4]) {
        unsigned char **dstP[4] = {&dst[0], &dst[1], &dst[2], &dst[3]};
