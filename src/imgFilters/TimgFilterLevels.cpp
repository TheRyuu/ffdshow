        ...
        if (csp_isYUVplanar(csp1)) {
            ...
            if (!oldSettings.onlyLuma) {
                ...
                for (unsigned int y=0; y<dy1[1]; y++) {
                    const unsigned char *srcu,*srcv;
                    unsigned char *dstu,*dstv,*dstuEnd;
            ...
            if      (lumaoffset==0 && chromaoffset==1 && oldSettings.onlyLuma==0) {
                processPacked<0,1,0>(srcY,dstY);
            } else if (lumaoffset==0 && chromaoffset==1 && oldSettings.onlyLuma==1) {
                processPacked<0,1,1>(srcY,dstY);
            } else if (lumaoffset==1 && chromaoffset==0 && oldSettings.onlyLuma==0) {
                processPacked<1,0,0>(srcY,dstY);
            } else if (lumaoffset==1 && chromaoffset==0 && oldSettings.onlyLuma==1) {
                processPacked<1,0,1>(srcY,dstY);
            }
        }
    }
