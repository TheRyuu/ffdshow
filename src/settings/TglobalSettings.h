...
#define BLACKLIST_EXE_FILENAME _l("oblivion.exe;morrowind.exe;age3.exe;gta-vc.exe;gta3.exe;gta_sa.exe;hl.exe;hl2.exe;pes6.exe;war3.exe;sh3.exe;sh4.exe;PES2008.exe;CM2008.exe;RF_Online.bin;Fable.exe;sacred.exe;Juiced2_HIN.exe")
