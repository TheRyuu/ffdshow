...
int TdialogSettingsDecVideo::getDefault(int id)
{
    switch (id) {
        case IDFF_lastPage:
            return IDD_POSTPROC;
        case IDFF_lvCodecsWidth0:
            return 90;
        case IDFF_lvCodecsWidth1:
            return 76;
        case IDFF_lvCodecsWidth2:
            return 202;
        default:
            return TdialogSettingsDec::getDefault(id);
    }
}
...
int TdialogSettingsEnc::getDefault(int id)
{
    switch (id) {
        ...
        case IDFF_lvCodecsWidth2:
            return 50;
        default:
            return TdialogSettingsBase::getDefault(id);
    }
}
...
void getUILanguage(const char_t* pth, char_t* lang)
{
    ...
    if (lang[0] == '\0') {
        ...
        _makepath_s(lngMask, MAX_PATH, NULL, pth, _l("languages\\ffdshow"), langfilesmask);
        strings langfiles;
