...
bool TpostprocSettings::getTip(unsigned int pageId, char_t *tipS, size_t len)
{
    ...
    switch (method) {
        case 0:
            ...
            break;
        case 1:
            strncat_s(tipS, len, _l("Nic's"), _TRUNCATE);
            break;
        case 2:
            strncat_s(tipS, len, nicFirst ? _l("Nic's + mplayer") : _l("mplayer + Nic's"), _TRUNCATE);
            break;
        case 4:
            strncat_s(tipS, len, _l("SPP"), _TRUNCATE);
            break;
        case 5:
            strncat_s(tipS, len, _l("fast SPP"), _TRUNCATE);
            break;
    }
    return true;
}
