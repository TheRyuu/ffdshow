...
TlogoawaySettings::TlogoawaySettings(TintStrColl *Icoll, TfilterIDFFs *filters): TfilterSettingsVideo(sizeof(*this), Icoll, filters, &idffs)
{
    ...
    static const TcreateParamList2<Tmode> listMode(modes, &Tmode::name);
    setParamList(IDFF_logoawayMode, &listMode);
    static const TcreateParamList1 listBord(borderModes);
    setParamList(IDFF_logoawayBordn_mode, &listBord);
    setParamList(IDFF_logoawayBords_mode, &listBord);
    setParamList(IDFF_logoawayBordw_mode, &listBord);
    setParamList(IDFF_logoawayBorde_mode, &listBord);
}
