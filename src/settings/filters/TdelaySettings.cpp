 ...
 static const TintOptionT<TdelaySettings> iopts[]=
  {
   ...
   IDFF_orderDelay ,&TdelaySettings::order,1,1,_l(""),1,
     _l("orderDelay"),0,
   IDFF_delayL     ,&TdelaySettings::l    ,0,5000,_l(""),1,
     _l("delayL"),0,
   IDFF_delayC     ,&TdelaySettings::c    ,0,5000,_l(""),1,
     _l("delayC"),0,
   IDFF_delayR     ,&TdelaySettings::r    ,0,5000,_l(""),1,
     _l("delayR"),0,
   IDFF_delaySL    ,&TdelaySettings::sl   ,0,5000,_l(""),1,
     _l("delaySL"),0,
   IDFF_delaySR    ,&TdelaySettings::sr   ,0,5000,_l(""),1,
     _l("delaySR"),0,
   IDFF_delayLFE   ,&TdelaySettings::lfe  ,0,5000,_l(""),1,
     _l("delayLFE"),0,
   0
  };
 addOptions(iopts);
