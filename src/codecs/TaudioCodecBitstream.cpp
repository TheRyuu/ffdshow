...
{
 if (bitstreamBuffer.size()==0) filledBytes+=8; // IEC header (8 bytes at the beginning of each bitstream frames) must be counted
...
{
 if (codecId!=CODEC_ID_BITSTREAM_TRUEHD) return;
