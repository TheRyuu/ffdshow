...
{
 if (guid == FORMAT_WaveFormatEx) return _l("FORMAT_WaveFormatEx");
 if (guid == KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS) return _l("KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS");
 if (guid == KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MLP) return _l("KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MLP");
 if (guid == KSDATAFORMAT_SUBTYPE_IEC61937_DTS_HD) return _l("KSDATAFORMAT_SUBTYPE_IEC61937_DTS_HD");
 if (guid == MEDIASUBTYPE_PCM) return _l("MEDIASUBTYPE_PCM");
 if (guid == MEDIASUBTYPE_DTS) return _l("MEDIASUBTYPE_DTS");
 if (guid == MEDIASUBTYPE_DOLBY_AC3) return _l("MEDIASUBTYPE_DOLBY_AC3");
 if (guid == MEDIASUBTYPE_DOLBY_AC3_SPDIF) return _l("MEDIASUBTYPE_DOLBY_AC3_SPDIF");
 if (guid == MEDIASUBTYPE_IEEE_FLOAT) return _l("MEDIASUBTYPE_IEEE_FLOAT");
 if (guid == MEDIASUBTYPE_DOLBY_TRUEHD) return _l("MEDIASUBTYPE_DOLBY_TRUEHD");
 if (guid == MEDIASUBTYPE_DTS_HD) return _l("MEDIASUBTYPE_DTS_HD");
 if (guid == MEDIASUBTYPE_EAC3) return _l("MEDIASUBTYPE_EAC3");
...
int TsampleFormat::getSampleFormat(CodecID codecId)
{
 switch(codecId)
 {
  ...
  case CODEC_ID_BITSTREAM_EAC3: return TsampleFormat::SF_EAC3;
 ...
 void TsampleFormat::DPRINTMediaTypeInfo(CMediaType mt)
 {
  ...
  if (mt.formattype==FORMAT_WaveFormatEx)
  {
   ...
   {
   case WAVE_FORMAT_EXTENSIBLE:formatDescr.append(_l("WAVE_FORMAT_EXTENSIBLE"));break;
    case WAVE_FORMAT_MLP:formatDescr.append(_l("MLP"));break;
    case 8192:formatDescr.append(_l("Dolby AC3"));break;
    case WAVE_FORMAT_DOLBY_AC3_SPDIF:formatDescr.append(_l("Dolby AC3 SPDIF"));break;
    case WAVE_FORMAT_DTS:formatDescr.append(_l("DTS"));break;
    case WAVE_FORMAT_DTS_W:formatDescr.append(_l("DTS wave"));break;
    case WAVE_FORMAT_EAC3:formatDescr.append(_l("Dolby Digital Plus"));break;
    case WAVE_FORMAT_TRUEHD:formatDescr.append(_l("Dolby True HD"));break;
    case WAVE_FORMAT_DTS_HD:formatDescr.append(_l("DTS HD"));break;
    case WAVE_FORMAT_PCM:formatDescr.append(_l("PCM"));break;
    case WAVE_FORMAT_PCM16:formatDescr.append(_l("PCM 16"));break;
