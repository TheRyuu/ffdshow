...
public:
    ...
    static const char_t *descriptionPCM(int sf, bool pcm_be = false) {
        switch (sf) {
            case SF_PCM8:
                return _l("8-bit integer");
            case SF_PCM16:
                return pcm_be ? _l("16-bit integer BE") : _l("16-bit integer");
            case SF_PCM24:
                return pcm_be ? _l("24-bit integer BE") : _l("24-bit integer");
            case SF_PCM32:
                return pcm_be ? _l("32-bit integer BE") : _l("32-bit integer");
            case SF_FLOAT32:
                return pcm_be ? _l("32-bit float BE") : _l("32-bit float");
            case SF_FLOAT64:
                return pcm_be ? _l("64-bit float BE") : _l("64-bit float");
            case SF_AC3:
                return _l("AC3");
            case SF_LPCM16:
                return _l("16-bit LPCM");
            case SF_LPCM20:
                return _l("20-bit LPCM");
            case SF_TRUEHD:
                return _l("Bitstream Dolby TrueHD");
            case SF_DTSHD:
                return _l("Bitstream DTS-HD");
            case SF_EAC3:
                return _l("Bitstream Dolby Digital Plus");
            default:
                return _l("Unknown");
        }
    }
...
template<> struct TsampleFormatInfo<int16_t> {
    static inline int16_t min(void) {
        return SHRT_MIN;
    }
    static inline int16_t max(void) {
        return SHRT_MAX;
    }
    static inline unsigned int bps(void) {
        return 16;
    }
    static inline int sf(void) {
...
template<> struct TsampleFormatInfo<int24_t> {
    static inline int24_t min(void) {
        return -(1 << 23);
    }
    static inline int24_t max(void) {
        return (1 << 23) - 1;
    }
    static inline unsigned int bps(void) {
        return 24;
...
template<> struct TsampleFormatInfo<int32_t> {
    static inline int32_t min(void) {
        return _I32_MIN;
    }
    static inline int32_t max(void) {
        return _I32_MAX;
    }
    static inline unsigned int bps(void) {
        return 32;
                                ...
                                if (!parseOnly) {
                                    ...
                                    switch (sf) {
                                        case TsampleFormat::SF_PCM16:
                                            ret = read<int16_t>(nsamples);
                                            break;
                                        case TsampleFormat::SF_PCM32:
                                            ret = read<int32_t>(nsamples);
                                            break;
                                        case TsampleFormat::SF_FLOAT32:
                                            ret = read<float>(nsamples);
                                            break;
                                    }
                                    if (!ret) {
                                        this->clear();
