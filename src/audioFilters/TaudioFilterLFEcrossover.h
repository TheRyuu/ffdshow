...
int li, ri, ci, lfei, map[8];
float LFE_buf[256];
unsigned int lfe_pos;
TfirFilter::_ftype_t *filter_coefs_lfe;
unsigned int lenLFE;
float LFE_bufL[256 + 1], LFE_bufR[256 + 1], LFE_bufC[256 + 1];
unsigned int lfe_posL, lfe_posR, lfe_posC;
TfirFilter::_ftype_t *filter_coefs_lfeLR;
unsigned int lenLFElr;
