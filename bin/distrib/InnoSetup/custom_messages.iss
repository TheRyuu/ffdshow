...
de.comp_SetupLabelV3=Listen Sie die Namen von ausführbaren Dateien auf, die kompatibel mit dem ffdshow-Videodekoder sind - pro Zeile einen.
de.comp_SetupLabelA1=Verwaltung von Kompatibilitätsproblemen (AUDIO)
de.comp_SetupLabelA2=Dieses Mal AUDIO-Dekoderkonfiguration. Bitte konfigurieren Sie auch diesen.%nSie können dies nach der Installation unter "DirectShow-Optionen" ändern.
de.comp_SetupLabelA3=Listen Sie die Namen von ausführbaren Dateien auf, die kompatibel mit dem ffdshow-Audiodekoder sind - pro Zeile einen.
