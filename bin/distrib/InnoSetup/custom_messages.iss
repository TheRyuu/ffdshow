...
;fr.WinVersionTooLowError=This build of [name] requires Windows 2000 or newer. Revision 2352 of [name] is the last one that works on Windows 98/ME.
...
;fr.spk_rear_1ch=rear 1ch
fr.spk_front_2ch=2 canaux avant
;fr.spk_side_2ch=side 2ch
;fr.spk_rear_2ch=rear 2ch
fr.spk_front_3ch=3 canaux avant
fr.spk_5ch=3 canaux avant + 2 canaux arrière
;fr.spk_7ch=front 3ch + side 2ch + rear 2ch
...
fr.spk_hrtf=Fonction de transfert relier a la tête (HRTF)
...
;fr.spk_unknownSpk=Unknown speaker configuration

fr.plg_Label1=Sélectionner le dossier de plugin %1
fr.plg_Label2=Ou doit-etre installer le plugin %1 ?
fr.plg_Label3=Sélectionner le dossier ou doit être installer le plugin %1, et appuyer sur suivant.
