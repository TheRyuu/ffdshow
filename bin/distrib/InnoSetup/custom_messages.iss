...
de.FileAbortRetryIgnore=Beenden sie das Programm, dass ffdshow verwendet und klicken sie auf "Wiederholen". Sollte das Problem weiterhin bestehen, klicken sie auf "Abbrechen", starten sie ihren Computer neu und führen sie das Setup erneut aus.
...
; Japanese
jp.langid=1041
jp.ffdshowds=ffdshow DirectShow ƒtƒBƒ‹ƒ^[
jp.vfwinterface=VFW ƒCƒ“ƒ^[ƒtƒF[ƒX
jp.makeavis=AviSynth ƒXƒNƒŠƒvƒgƒT[ƒrƒ“ƒO
jp.appplugins=ƒAƒvƒŠƒP[ƒVƒ‡ƒ“ƒvƒ‰ƒOƒCƒ“
jp.resetsettings=ffdshow‚Ì‚·‚×‚Ä‚Ìİ’è‚ğ‰Šú’l‚É–ß‚·
jp.videoformats=ˆÈ‰º‚Ì‚·‚×‚Ä‚ÌƒrƒfƒIƒtƒH[ƒ}ƒbƒg‚ğffdshow‚ÅƒfƒR[ƒh‚·‚é
jp.audioformats=ˆÈ‰º‚Ì‚·‚×‚Ä‚ÌƒI[ƒfƒBƒIƒtƒH[ƒ}ƒbƒg‚ğffdshow‚ÅƒfƒR[ƒh‚·‚é
jp.defaultfilters=ˆÈ‰º‚ÌƒtƒBƒ‹ƒ^[‚ğ—LŒø‚É‚·‚é
jp.volumenorm=ƒ{ƒŠƒ…[ƒ€ ƒm[ƒ}ƒ‰ƒCƒY
jp.subtitles=š–‹
jp.speakersetup=ƒXƒs[ƒJ[‚Ìİ’è
jp.runaudioconfig=ƒI[ƒfƒBƒIƒfƒR[ƒ_[‚Ìİ’è‚ğs‚¤
jp.runvideoconfig=ƒrƒfƒIƒfƒR[ƒ_[‚Ìİ’è‚ğs‚¤
jp.runvfwconfig=VFW‚Ìİ’è‚ğs‚¤
jp.audioconfig=ƒI[ƒfƒBƒIƒfƒR[ƒ_[‚Ìİ’è
jp.videoconfig=ƒrƒfƒIƒfƒR[ƒ_[‚Ìİ’è
jp.vfwconfig=VFW‚Ìİ’è
jp.uninstall=ffdshow‚ÌƒAƒ“ƒCƒ“ƒXƒg[ƒ‹
jp.SelectPluginDirLabel1=%1 ƒvƒ‰ƒOƒCƒ“ƒCƒ“ƒXƒg[ƒ‹æ‚Ìw’è
jp.SelectPluginDirLabel2=%1‚ÌƒCƒ“ƒXƒg[ƒ‹æ‚ğw’è‚µ‚Ä‚­‚¾‚³‚¢B
jp.SelectPluginDirLabel3=%1 ƒvƒ‰ƒOƒCƒ“‚ğƒCƒ“ƒXƒg[ƒ‹‚·‚éƒtƒHƒ‹ƒ_‚ğw’è‚µ‚ÄAuŸ‚Öv‚ğƒNƒŠƒbƒN‚µ‚Ä‚­‚¾‚³‚¢B
jp.speakersetup=ƒXƒs[ƒJ[‚Ìİ’è
jp.SpeakerSetupLabel2=Œ»İ‚ÌƒRƒ“ƒsƒ…[ƒ^\¬‚ÉÅ‚à‹ß‚¢ƒXƒs[ƒJ[‚Ìí—Ş‚ğ‘I‚ñ‚Å‚­‚¾‚³‚¢B%nƒCƒ“ƒXƒg[ƒ‹Œã‚Éuƒ~ƒLƒT[v‚Ìİ’è‚©‚ç•ÏX‚·‚é‚±‚Æ‚ào—ˆ‚Ü‚·B
jp.SpeakerSetupLabel3=ƒXƒs[ƒJ[‚Ìí—Ş

jp.spk_headphone=ƒwƒbƒhƒtƒHƒ“
jp.spk_stereo=ƒXƒeƒŒƒI
jp.spk_quadro=ƒtƒƒ“ƒg 2ch { ƒŠƒA 2ch
jp.spk_5ch=ƒtƒƒ“ƒg 3ch { ƒŠƒA 2ch
jp.spk_MixerDisable=ƒ~ƒLƒT[‚ğ–³Œø‚É‚·‚é
...
jp.comp_SetupLabelV1=ŒİŠ·«–â‘è‚ÌŠÇ—iƒrƒfƒIj
jp.comp_SetupLabelV2=ƒQ[ƒ€‚È‚Ç‚Åffdshow‚ªƒCƒ“ƒXƒg[ƒ‹‚³‚ê‚Ä‚¢‚é‚ÆƒNƒ‰ƒbƒVƒ…‚µ‚½‚èƒtƒŠ[ƒY‚·‚é‚±‚Æ‚ª‚ ‚é‚½‚ßuˆÈ‰º‚Å‚Ì‚İffdshow‚ğg—p‚·‚év‚ğ‘I‘ğ‚·‚é‚±‚Æ‚ğ‚¨Š©‚ß‚µ‚Ü‚·B
jp.comp_SetupLabelV3=ffdshowƒrƒfƒIƒfƒR[ƒ_‚ÆŒİŠ·«‚Ì‚ ‚éƒAƒvƒŠƒP[ƒVƒ‡ƒ“‚ğ1s‚É1‚Â‚¸‚Â—ñ‹“‚µ‚Ä‚­‚¾‚³‚¢B
jp.comp_SetupLabelA1=ŒİŠ·«–â‘è‚ÌŠÇ—iƒI[ƒfƒBƒIj
jp.comp_SetupLabelA2=¡“x‚ÍƒI[ƒfƒBƒIƒfƒR[ƒ_‚Ìİ’è‚Å‚·B“¯—l‚Éİ’è‚µ‚Ä‚­‚¾‚³‚¢B%nƒCƒ“ƒXƒg[ƒ‹Œã‚Éuî•ñ‚ÆƒfƒoƒbƒOv‚Ìİ’è‚©‚ç•ÏX‚·‚é‚±‚Æ‚ào—ˆ‚Ü‚·B
...
de.makeavis=Hilfe für AviSynth-Skripte
de.appplugins=Anwendungsplungins:
de.resetsettings=Alle ffdshow-Einstellungen zurücksetzen
de.videoformats=Folgende Videoformate mit ffdshow dekodieren:
de.genericMpeg4=Gewöhnliches MPEG-4
...
de.defaultfilters=Folgende Filter standardmäßig aktivieren:
de.volumenorm=Lautstärke-Normalisierung
de.subtitles=Untertitel
de.tweaks=Optimierungen
de.skipinloop=Internes H.264-Deblocking immer überspringen
...
de.runaudioconfig=Audiodekoder-Konfiguration ausführen
de.runvideoconfig=Videodekoder-Konfiguration ausführen
de.runvfwconfig=VFW-Konfiguration ausführen
de.SelectPluginDirLabel1=%1pluginordner auswählen
...
fr.resetsettings=Réinitialiser tous les paramètres ffdshow
fr.videoformats=Décoder les formats vidéo suivants avec ffdshow :
fr.audioformats=Décoder les formats audio suivants avec ffdshow :
fr.defaultfilters=Activer les filtres suivant par défaut :
...
fr.skipinloop=Toujours sauter le deblocking intégrEH.264
fr.audioconfig=Configuration décodeur audio
fr.videoconfig=Configuration décodeur vidéo
fr.vfwconfig=Configuration VFW
fr.uninstall=Désinstaller ffdshow
fr.runaudioconfig=Lancer la configuration décodeur audio
fr.runvideoconfig=Lancer la configuration décodeur vidéo
fr.runvfwconfig=Lancer la configuration VFW

; Russian
ru.langid=1049
ru.ffdshowds=ffdshow DirectShow-ôèëüòğ
ru.vfwinterface=VFW èíòåğôåéñ
ru.makeavis=Îáñëóæèâàíèå ñêğèïòîâ AviSynth
ru.appplugins=Ïëàãèíû ïğèëîæåíèé:
ru.resetsettings=Ñáğîñèòü âñå íàñòğîéêè ffdshow
ru.videoformats=Äåêîäèğîâàòü ñëåäóşùèå âèäåîôîğìàòû ñ ffdshow:
ru.genericMpeg4=Generic MPEG-4
ru.rawvideo=RAW Video
ru.audioformats=Äåêîäèğîâàòü ñëåäóşùèå àóäèîôîğìàòû ñ ffdshow:
ru.rawaudio=RAW Audio
ru.defaultfilters=Âêëş÷èòü ñëåäóşùèå ôèëüòğû ïî óìîë÷àíèş:
ru.volumenorm=Íîğìàëèçàöèÿ çâóêà
ru.subtitles=Ñóáòèòğû
ru.tweaks=Îïòèìèçàöèè
ru.skipinloop=Îòêëş÷èòü ñîáñòâåííûé äåáëîêèíã H.264
ru.audioconfig=Êîíôèãóğàöèÿ àóäèîäåêîäåğà
ru.videoconfig=Êîíôèãóğàöèÿ âèäåîäåêîäåğà
ru.vfwconfig=Êîíôèãóğàöèÿ VFW èíòåğôåéñà
ru.uninstall=Äåèíñòàëëÿöèÿ ffdshow
ru.runaudioconfig=Çàïóñòèòü êîíôèãóğàöèş àóäèîäåêîäåğà
ru.runvideoconfig=Çàïóñòèòü êîíôèãóğàöèş âèäåîäåêîäåğà
ru.runvfwconfig=Çàïóñòèòü êîíôèãóğàöèş VFW èíòåğôåéñà
ru.SelectPluginDirLabel1=Âûáîğ ïàïêè ïëàãèíà äëÿ %1
ru.SelectPluginDirLabel2=Â êàêóş ïàïêó äîëæåí áûòü óñòàíîâëåí ïëàãèí äëÿ %1?
ru.SelectPluginDirLabel3=Âûáåğèòå ïàïêó, â êîòîğóş äîëæåí áûòü óñòàíîâëåí ïëàãèí äëÿ %1, çàòåì íàæìèòå "Äàëåå".

ru.speakersetup=Íàñòğîéêà àóäèîñèñòåìû
ru.SpeakerSetupLabel2=Âûáåğèòå êîíôèãóğàöèş äèíàìèêîâ, ñîâïàäàşùóş ñ Âàøåé. Âû ìîæåòå èçìåíèòü å¸ ïîñëå óñòàíîâêè, èñïîëüçóÿ íàñòğîéêè "Ìèêøåğ".
ru.SpeakerSetupLabel3=Àóäèîñèñòåìà:
ru.spk_headphone=íàóøíèêè
ru.spk_stereo=ñòåğåî
ru.spk_quadro=êâàäğî
ru.spk_5ch=5 êàíàëîâ
ru.spk_MixerDisable=îòêëş÷èòü Ìèêøåğ
...
pl.makeavis=obs³uga skryptów AviSynth
pl.appplugins=Pluginy innych aplikacji:
pl.resetsettings=Zresetuj wszystkie ustawienia ffdshow
pl.videoformats=Dekoduj nastêpuj¹ce fomaty wideo u¿ywaj¹c ffdshow:
pl.genericMpeg4=Ogólne MPEG-4
pl.rawvideo=Nieskompresowane wideo
pl.audioformats=Dekoduj nastêpuj¹ce fomaty wideo u¿ywaj¹c ffdshow:
pl.rawaudio=Nieskompresowane audio
pl.defaultfilters=W³¹cz nastêpuj¹ce filtry jako domyœlne:
pl.volumenorm=Normalizacja g³oœnoœci
pl.subtitles=Napisy
...
pl.runaudioconfig=Uruchom konfiguracjê dekodera audio
pl.runvideoconfig=Uruchom konfiguracjê dekodera wideo
pl.runvfwconfig=Uruchom konfiguracjê VFW
pl.SelectPluginDirLabel1=Wybierz katalog pluginu %1
pl.SelectPluginDirLabel2=Gdzie powinien zostaæ zainstalowany plugin %1?
pl.SelectPluginDirLabel3=Wybierz folder, w którym instalator powinien zainstalowaæ plugin %1 i wciœnij Dalej.

pl.speakersetup=Ustawienia g³oœników
pl.SpeakerSetupLabel2=Wybierz rodzaj g³oœników z listy poni¿ej, który najbardziej odpowiada twojej konfiguracji. Po instalacji, ustawienia te mo¿esz zmieniæ w zak³adce "Mikser" w konfiguracji dekodera audio.
pl.SpeakerSetupLabel3=Rodzaj g³oœników:
pl.spk_headphone=s³uchawki
pl.spk_stereo=stereofoniczne
pl.spk_quadro=kwadrofoniczne
pl.spk_5ch=3 kana³y przednie + 2 tylne
pl.spk_MixerDisable=wy³¹cz Mikser
